...
import com.inventory.productmanagementsss.services.AuthenticationService;
import com.inventory.productmanagementsss.exception.AuthenticationFailException;
import com.inventory.productmanagementsss.exception.CustomException;
import com.inventory.productmanagementsss.repository.UserRepository;
   ...
   @Autowired
    ...
    public SignInResponseDto signIn(SignInDto signInDto) {
      ...
      if (Objects.isNull(token)) {
        ...
        return new SignInResponseDto("sucess", "xyz");
